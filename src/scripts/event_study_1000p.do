...
* =============================================================================
* Variant: Restrict sample to ZIP codes with population >= 1,000
* Outputs written to output/results_1000p and output/event_study_1000p.log
* =============================================================================
*
...
global results "$output/results_1000p"
cap mkdir "$output"
cap mkdir "$results"

capture log using "$output/event_study_1000p.log", text replace
clear all
set more off
set scheme s2color
